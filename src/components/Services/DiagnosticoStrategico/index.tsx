    ...
    return (
        <section id="diagnostico" className="px-6 py-16 md:py-24 bg-gray-50/60">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Plan cards — overflow-visible so badge is not clipped */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {plans.map((plan, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Featured badge — outside pt-10 flow, using mt negative trick */}
                                {plan.featured && (
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
                    ...
                    <Link href={`/${locale}/contact`}>
                        <button className="flex-shrink-0 bg-lyratech-purple text-white font-montserrat-bold text-sm px-7 py-3 rounded-xl hover:bg-[#5058a0] transition-colors duration-200">
                            {t("ctaButton")}
                        </button>
                    </Link>
                </div>
